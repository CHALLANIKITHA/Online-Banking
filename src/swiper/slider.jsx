  ...
  render() {
    return (
      <div>
        ...
        <section className='d-md-block d-lg-none d-none p-4 m-3 card bg-transparent'>
          <Swipemd />
        </section>
        <section className='d-none d-sm-block d-md-none p-4 m-5 card bg-transparent'>
          <Swipesm />
        </section>
        <section className='d-sm-none p-4 m-5 card bg-transparent'>
          <Swipevs />
        </section>
      </div>
    );
